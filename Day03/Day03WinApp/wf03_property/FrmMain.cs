...
namespace wf03_property
{
    public partial class FrmMain : Form
    {
        ...
        {
            GbxMain.Text = "컨트롤 학습";
            var fonts = FontFamily.Families.ToList();   //  내 OS폰트
        ...
        private void ChangeFontStyle()
        {
            ...
            {
                CboFontFamily.SelectedIndex = 275;      // 디폴트는 나눔고딕 지정
            }
        ...
        private void BtnMsgBox_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(TxtResult.Text, "메시지창", MessageBoxButtons.YesNo, MessageBoxIcon.Error,
                            MessageBoxDefaultButton.Button2);                                 // 기본포커스버튼설정
        ...
        {
            TrvDummy.Nodes.Add(rnd.Next().ToString());        // 13열에 Random 추가
        }
