...
namespace cs21_property
{
    class Boiler
    {
        ...
        // 위의 get; set;과 비교     // 아래의 Get매서드는 Java에서만 사용, C#은 거의 사용 안함
    ...
    class Car
    {
        ...
        public string Name { get; set; }    // 필터링이 필요없으면 멤버변수 없이 
        public string Color { get; set; }

        // 들어오는 데이터를 필터링할때는 private 멤버변수와 public 프로퍼티를 둘 다 사용
        public int Year {
