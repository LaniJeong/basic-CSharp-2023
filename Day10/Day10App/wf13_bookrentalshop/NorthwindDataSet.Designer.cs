            ...
            public string Phone {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Shippers\' 테이블의 \'Phone\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
...
namespace wf13_bookrentalshop.NorthwindDataSetTableAdapters {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::wf13_bookrentalshop.Properties.Settings.Default.NorthwindConnectionString;
        }
